			...
			<div class="page-content">
				<div class="mdl-grid">
					...
					<div class="mdl-cell--6-col">
						...
						<form:form name="menuItemForm" method="post" action="/edit-menu-item" 
						modelAttribute="menuItem" onsubmit="return validateForm()">
							...
							<div class="form-group">
								...
								<form:input id="name" type="text" class="form-control" path="id" disabled="true" />
							</div>						
